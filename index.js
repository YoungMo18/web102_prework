...
const displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has ` +
    `been raised for ${totalGames.toLocaleString('en-US')} games. Currently, ` +
    `${totalUnfunded == 1 ? "1 game remains unfunded." : totalUnfunded + " games remain unfunded."}` +
    ` We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const pDescription = document.createElement("p");
pDescription.textContent = displayStr;
...
const [first, second] = sortedGames; // I can't find a place to use the spread operator
